...
declare module 'motia' {
  interface FlowContextStateStreams {
    ...
    'chessLeaderboard': MotiaStream<{ provider: 'openai' | 'gemini' | 'claude'; model: string; gamesPlayed: number; wins: number; draws: number; illegalMoves: number }>
    'chessGame': MotiaStream<{ id: string; fen: string; turn: 'white' | 'black'; status: 'pending' | 'completed' | 'draw'; lastMove?: string[]; winner?: 'white' | 'black'; turns?: number; endGameReason?: string; players: { white: { name: string; ai?: 'openai' | 'gemini' | 'claude'; illegalMoveAttempts?: number }; black: { name: string; ai?: 'openai' | 'gemini' | 'claude'; illegalMoveAttempts?: number } }; check: boolean }>
  ...
  type Handlers = {
    ...
    'MovePiece': ApiRouteHandler<{ password: string; promote?: 'queen' | 'rook' | 'bishop' | 'knight'; from: string; to: string }, ApiResponse<200, { id: string; fen: string; turn: 'white' | 'black'; status: 'pending' | 'completed' | 'draw'; lastMove?: string[]; winner?: 'white' | 'black'; turns?: number; endGameReason?: string; players: { white: { name: string; ai?: 'openai' | 'gemini' | 'claude'; illegalMoveAttempts?: number }; black: { name: string; ai?: 'openai' | 'gemini' | 'claude'; illegalMoveAttempts?: number } }; check: boolean }> | ApiResponse<400, { message: string }> | ApiResponse<404, { message: string }>, { topic: 'chess-game-moved'; data: { gameId: string; fenBefore: string } } | { topic: 'chess-game-ended'; data: { gameId: string } }>
    'GetGame': ApiRouteHandler<{}, ApiResponse<200, { id: string; fen: string; turn: 'white' | 'black'; status: 'pending' | 'completed' | 'draw'; lastMove?: string[]; winner?: 'white' | 'black'; turns?: number; endGameReason?: string; players: { white: { name: string; ai?: 'openai' | 'gemini' | 'claude'; illegalMoveAttempts?: number }; black: { name: string; ai?: 'openai' | 'gemini' | 'claude'; illegalMoveAttempts?: number } }; check: boolean; role: 'white' | 'black' | 'spectator' | 'root'; username: string; passwords?: { root: string; white: string; black: string } }> | ApiResponse<404, { message: string }>, never>
    'GetLiveAiGame': ApiRouteHandler<{ players: 'openai' | 'gemini' | 'claude'[] }, ApiResponse<200, { id: string; fen: string; turn: 'white' | 'black'; status: 'pending' | 'completed' | 'draw'; lastMove?: string[]; winner?: 'white' | 'black'; turns?: number; endGameReason?: string; players: { white: { name: string; ai?: 'openai' | 'gemini' | 'claude'; illegalMoveAttempts?: number }; black: { name: string; ai?: 'openai' | 'gemini' | 'claude'; illegalMoveAttempts?: number } }; check: boolean }> | ApiResponse<400, { message: string; errors?: { message: string }[] }> | ApiResponse<404, { message: string }>, { topic: 'chess-game-created'; data: { gameId: string; fenBefore: string } }>
    'CreateGame': ApiRouteHandler<{ players: { white: { name: string }; black: { name: string; ai?: 'openai' | 'gemini' | 'claude' } } }, ApiResponse<200, { id: string; fen: string; turn: 'white' | 'black'; status: 'pending' | 'completed' | 'draw'; lastMove?: string[]; winner?: 'white' | 'black'; turns?: number; endGameReason?: string; players: { white: { name: string; ai?: 'openai' | 'gemini' | 'claude'; illegalMoveAttempts?: number }; black: { name: string; ai?: 'openai' | 'gemini' | 'claude'; illegalMoveAttempts?: number } }; check: boolean }> | ApiResponse<400, { message: string; errors: { message: string }[] }>, { topic: 'chess-game-created'; data: { gameId: string; fenBefore: string } }>
  }
}