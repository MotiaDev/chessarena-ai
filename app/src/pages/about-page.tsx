        ...
        <div className="flex flex-col flex-1 gap-4 items-center justify-between w-full h-full">
          ...
          <div className="flex flex-col gap-2 items-center justify-center">
            ...
            <Paragraph>
              ...
              to have a leaderboard of the best models in chess, but after researching and validating LLMs to play
              chess, we found that they can't really win games. This is because they don't have a good understanding of
              the game.
            </Paragraph>
            <Paragraph>
              In fact, the majority of the matches end in draws. So instead of tracking wins and losses, we focus on
              move quality and game insight. Each game is evaluated using{' '}
            ...
            <Paragraph>
              On each move, we get what would be the best move using Stockfish to get the difference between the best
              move and the move made by the LLM, that's called move swing. If move swing is higher than 100 centipawns,
              we consider it a blunder.
            </Paragraph>
