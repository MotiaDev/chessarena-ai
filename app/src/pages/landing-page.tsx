  ...
  return (
    <PageGrid>
      ...
      <PageGridRightColumn className="backdrop-blur-none md:backdrop-blur-lg">
        <TopBar />
        <div className="flex flex-col justify-center grow gap-3 text-center">
          <ChessArenaLogo />
          <p className="font-medium text-center text-muted-foreground">
            Benchmarking LLM chess reasoning with transparent, reproducible evaluation.
          </p>
          <button
        ...
        <div className="flex flex-col gap-4 items-center justify-center w-full">
          ...
          <p className="font-medium text-sm text-center text-muted-foreground">
            Open source benchmark built with{' '}
            <a href="https://motia.dev" target="_blank" className="text-white underline">
              Motia
            </a>
            .{' '}
            <a href="/about" className="text-white underline" onClick={(e) => { e.preventDefault(); navigate('/about') }}>
              Learn more
            </a>
          </p>
        </div>
