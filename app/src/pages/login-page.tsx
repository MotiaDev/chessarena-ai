...
export const LoginPage = () => {
  ...
  return (
    <Page className="p-6 md:max-w-[480px] md:ml-auto md:border-l-2 md:border-white/5 backdrop-blur-lg overflow-y-auto">
      <div className="flex flex-col flex-1 gap-10 items-center justify-between w-full">
