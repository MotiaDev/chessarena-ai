        ...
        <div className="flex flex-col flex-1 gap-4 items-center justify-between w-full h-full">
          ...
          <div className="flex flex-col gap-2 items-center justify-center">
            ...
            <div className="p-6 max-w-3xl mx-auto">
              ...
              <Paragraph>
                Motia ("we," "our," or "us") respects your privacy and is committed to protecting it. This Privacy
              ...
              <Paragraph>
                You may disconnect your Google account at any time through your account settings. Doing so will revoke
                our access to your Google information.
              </Paragraph>
              <Paragraph>
              ...
              <Paragraph>
                Our app is not directed to individuals under 13. We do not knowingly collect personal data from
                children.
              </Paragraph>
