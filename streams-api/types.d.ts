...
declare module 'motia' {
  interface FlowContextStateStreams {
    'chessGame': MotiaStream<{ id: string; fen: string; turn: 'white' | 'black'; status: 'created' | 'pending' | 'completed' | 'draw'; lastMove?: string[]; winner?: 'white' | 'black'; players: { white: { name: string; ai?: 'openai' | 'gemini' | 'claude' }; black: { name: string; ai?: 'openai' | 'gemini' | 'claude' } }; check: boolean }>
