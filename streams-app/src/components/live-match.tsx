...
export const LiveMatch: React.FC<Props> = ({ white, black }) => {
  return (
    <Card className="flex flex-row gap-2 items-center justify-between w-full px-8 py-6 hover:bg-white/15 cursor-pointer">
